...
def run_autonomous_task():
    ...
    prompt = (
        ...
        "- If the research leaves a real unresolved question, update gaps.json with a concise\n"
        "  named gap: id, title, entry, entry_title, type, and question. Do not force this every\n"
        "  session; gaps are for specific open mechanisms, contested accounts, structural unknowns,\n"
        "  or methodological limits that remain after the entry stops.\n\n"
        ...
        "- If you updated gaps.json, include it in the public artifact updates and make sure\n"
        "  gaps.html still reads naturally as the living open-questions surface.\n"
