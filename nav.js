...
(function () {
  ...
  var MORE_GROUPS = [
    ...
    { cat: 'navigate', links: [
      ...
      { href: '/support.html', label: 'what carries an entry' },
  ...
  var NAV_HINTS = {
    ...
    '/support.html': 'See the public paths that help one journal entry remain findable without treating them as proof.',
